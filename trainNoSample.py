...
from mscnNoSample.data import get_train_datasets, load_data, make_dataset
from mscnNoSample.model import SetConvNoSample
...
def train_and_predict(workload_name, num_queries, num_epochs, batch_size, hid_units, cuda):
    ...
    model = SetConvNoSample(predicate_feats, join_feats, hid_units)
